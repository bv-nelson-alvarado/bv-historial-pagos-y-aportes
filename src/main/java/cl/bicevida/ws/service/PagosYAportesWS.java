...
public class PagosYAportesWS extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Users/gustavo.riquelmeg/workspace/bv-historial-pagos-y-aportes/src/main/resources/wsdl/PagosYAportesPort.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(PagosYAportesWS.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/Users/gustavo.riquelmeg/workspace/bv-historial-pagos-y-aportes/src/main/resources/wsdl/PagosYAportesPort.wsdl");
        }
        WSDL_LOCATION = url;
    }
